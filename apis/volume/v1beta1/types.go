...
import (
	...
	v1alpha1 "github.com/rossigee/provider-docker/apis/volume/v1alpha1"
)
...
func (cr *Volume) GetProviderConfigReference() *xpv1.ProviderConfigReference {
	return cr.Spec.ProviderConfigReference
}

// SetProviderConfigReference sets the provider config reference.
func (cr *Volume) SetProviderConfigReference(r *xpv1.ProviderConfigReference) {
	cr.Spec.ProviderConfigReference = r
}

// GetWriteConnectionSecretToReference returns the write connection secret to reference.
func (cr *Volume) GetWriteConnectionSecretToReference() *xpv1.LocalSecretReference {
...
func (cr *Volume) SetWriteConnectionSecretToReference(r *xpv1.LocalSecretReference) {
